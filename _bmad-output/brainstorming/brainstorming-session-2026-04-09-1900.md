...
|---|------|------|---------|------|
| 1 | S-替代 | 弹幕互动系统 | 中 | ✅ 已上线 |
| 2 | S-替代 | 代码点赞 / AI 回复打分排行榜 | 低 | ❌ 未开始 |
| 3 | S-替代 | Prompt 投票墙 / 众筹方向 | 中 | ❌ 未开始 |
| 4 | S-替代 | 编程竞赛直播平台（码竞） | 高 | ❌ 未开始 |
| 5 | C-合并 | cc-live + Discord 社区大厅 | 中 | ❌ 未开始 |
| 6 | A-适配 | 游戏成就解锁系统 | 低 | ❌ 未开始 |
| 7 | M-修改 | AI 自动生成"今日开发精华" | 中 | ❌ 未开始 |
| 8 | P-转用 | 新人 onboarding 教材 | 低 | ❌ 未开始 |
| 9 | E-消除 | 全屏沉浸 zen mode | 低 | ❌ 未开始 |
| 10 | E-消除 | 大屏展示 / 表演编程模式 | 低 | ❌ 未开始 |
| 11 | 跨界 | 开发数据面板（代码速度计、工具热力图） | 中 | ✅ 已上线 |
| 12 | 跨界 | 实时事件流（像电竞 kill feed） | 低 | ❌ 取消（信息重复，价值不足） |
| 13 | 外星 | 开发者叙事层（任务状态栏） | 低 | ❌ 未开始 |
| 14 | **外星** | **语音直播功能（双通道：代码流 + 语音解说）** | **中** | ❌ 未开始 |
